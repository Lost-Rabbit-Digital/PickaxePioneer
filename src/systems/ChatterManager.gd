...
var messages: Array[String] = [
	...
	"Upgrade your carapace to survive longer.",
	"The exit station is your only way out.",
	"Watch your carapace integrity!",
	"Sharper mandibles dig faster.",
	"Stronger legs let you dig deeper.",
	"Minerals are life out here.",
	"Don't get greedy, get out alive.",
	"Different mines have different ore richness.",

	# Lore
	"The colony grows ever deeper.",
